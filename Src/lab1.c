...
/**
 * PART 2 main function (Read button on PA0, toggle LEDs on PC6, PC7 with debounce)
 */
int lab1_part2_main(void)
{
    ...
    // Initial LED states
    MY_HAL_GPIO_WritePin(GPIOC, 6, 0); // PC6 off
    MY_HAL_GPIO_WritePin(GPIOC, 7, 1); // PC7 on
